...
import { v4 as uuidv4 } from 'uuid';
  ...
  return ( 
    ...
    <div className="bigcontainer flex justify-center items-center h-[80vh] sm:h-[83vh]">
      ...
      <div className="Container w-[80vw] sm:w-[50vw]  bg-purple-200 min-h-[70vh] sm:min-h-[80vh]  mt-8 rounded-4xl px-10 py-5 box-border">
        ...
        <div className="line w-[38vw] mt-9 border m-auto border-slate-400 rounded-4xl"></div>
